...
app.include_router(admin_promo.router, prefix="/v1/admin", tags=["Admin - Promo"])
app.include_router(admin_promocodes.router, prefix="/v1/admin", tags=["Admin - Promocodes"])
