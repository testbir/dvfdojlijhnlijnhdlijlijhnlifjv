...
async def remove_banner(banner_id: int, current_admin: AdminUser = Depends(get_current_admin_user)):
...
async def remove_promo(promo_id: int, current_admin: AdminUser = Depends(get_current_admin_user)):
